      ...
      <div className="topper-scroll-container flex gap-3 sm:gap-4 md:gap-5 overflow-x-auto pb-3 sm:pb-4 md:pb-6 snap-x snap-mandatory no-scrollbar scroll-smooth">
        {toppers.map((topper, idx) => (
          <div 
            ...
            className="flex-none w-[110px] sm:w-[125px] md:w-[140px] lg:w-[150px] aspect-[3/4.5] rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden relative group snap-start shadow-md sm:shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 cursor-pointer"
          >
